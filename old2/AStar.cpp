...
void AStar::reconstructPath() {
    ...
    tmp->parent->parent->state.printState();
    while (tmp != NULL) {
    ...
    current.parent->state.printState();
    current.parent->parent->state.printState();
    current.parent->parent->parent->state.printState();
    current.parent->parent->parent->parent->state.printState();
    */
}
